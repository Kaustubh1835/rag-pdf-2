  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Join thousands of users chatting with their documents using InsightPDF.
        </p>
        ...
        {error && (
          <p style={{ color: "#ef4444", fontSize: "14px", marginTop: "24px", fontWeight: 500 }}>
            {error}
          </p>
        )}

        <p style={{ color: "#94a3b8", fontSize: "12px", marginTop: "40px" }}>
          By continuing, you agree to InsightPDF's Terms of Service and Privacy Policy.
        </p>
      </div>
    </div>
  );
